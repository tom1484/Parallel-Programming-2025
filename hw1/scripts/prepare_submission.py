...
2. Merges headers and source code into submission/hw1.cpp
...
def extract_cmake_flags(build_dir="build/Release"):
    ...
    flags_file = os.path.join(build_dir, "CMakeFiles/hw1.dir/flags.make")
    link_file = os.path.join(build_dir, "CMakeFiles/hw1.dir/link.txt")
...
def main():
    ...
    # Write merged C++ file
    cpp_output = os.path.join(submission_dir, "hw1.cpp")
